...
static char *str; //The string to be printed in concurrent motor calls
static unsigned char index; //Index of the string at a given moment
static unsigned char state; //State of the motor
